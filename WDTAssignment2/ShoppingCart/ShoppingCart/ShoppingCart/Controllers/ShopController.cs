...
namespace ShoppingCart.Controllers
{
    public class ShopController : Controller
    {
        ...
        /* Deafult Shop page controller method */
        ...
        /* Controller method to use Ajax to update the quantity of a product in the cart without
         * having to relaod the page */
        [HttpPost]
        public string updateQTY()
        {
            ...
            using (ShoppingCartProductsEntities database = new ShoppingCartProductsEntities())
            {
                ...
                if (Session["cart"] != null)
                {
                    ...
                    /* If the cart contains the requested product */
